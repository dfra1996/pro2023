...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2023 a las 15:25:42
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `delcate` (`idcat` BIGINT(11))   BEGIN
  DELETE FROM category WHERE idcate = idcat;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `inscate` (`idcat` BIGINT(11), `cnam` VARCHAR(50), `cico` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insdom` (`iddo` BIGINT(11), `nomdo` VARCHAR(70), `pardo` VARCHAR(50))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insprod` (`idpro` BIGINT(11), `pnam` VARCHAR(50), `pric` VARCHAR(50), `trademar` VARCHAR(50), `mode` VARCHAR(100), `categor` BIGINT(11), `discoun` TINYINT(2), `cdescriptio` TEXT, `cstatu` TINYINT(1))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insprodimg` (`idim` BIGINT(11), `pfilenam` VARCHAR(250), `idpro` BIGINT(11))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateconfig` (`idconfi` BIGINT(12), `tittl` VARCHAR(20), `mnam` VARCHAR(20), `mdescriptio` VARCHAR(250), `heade` VARCHAR(40), `foote` VARCHAR(100), `caddres` VARCHAR(50), `faceboo` VARCHAR(300), `instagra` VARCHAR(300), `log` VARCHAR(300), `favico` VARCHAR(300), `ma` VARCHAR(300), `abou` TEXT, `cservice` TEXT, `phon` VARCHAR(20), `colorpr` VARCHAR(32), `colorse` VARCHAR(32), `fon` VARCHAR(50))   BEGIN
...
INSERT INTO `category` (`idcate`, `cname`, `cicon`) VALUES
(1, 'Electrodomesticos Linea blanca', 'fas fa-solid fa-tv'),
(2, 'Muebles ss', 'fas fa-solid fa-tv'),
(3, 'ElectrÃ³nica', 'fas fa solid fa-tv'),
(8, 'Colchones Amarillos', 'colchon.jpg'),
(10, 'Celulares 2023', 'fas fa-solid fa-tv'),
(11, 'Relojes', 'fas fa-solid fa-tv'),
(12, 'Sport', 'fas fa solid fa-tv'),
(13, 'Muebles cocina', 'fas fa-solid fa-tv'),
(14, '3434', 'ererer'),
(15, 'OTRASSSSSSSS', '');
...
(9, 'Marca', 'Marcas de productos U otrosdd'),
(10, 'Criterios', '#');
...
CREATE TABLE `files` (
  `idimg` bigint(11) NOT NULL,
  `pfilename` varchar(250) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `html_configuration`
--

CREATE TABLE `html_configuration` (
  `idconfig` bigint(12) NOT NULL,
  `tittle` varchar(20) NOT NULL,
  `mname` varchar(20) DEFAULT NULL,
  `mdescription` varchar(250) DEFAULT NULL,
  ...
  `about` text NOT NULL,
  `cservices` text NOT NULL,
  `phone` varchar(20) NOT NULL,
  `colorpry` varchar(32) NOT NULL,
  `colorsec` varchar(32) NOT NULL,
  `font` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `html_configuration`
--

INSERT INTO `html_configuration` (`idconfig`, `tittle`, `mname`, `mdescription`, `header`, `footer`, `caddress`, `facebook`, `instagram`, `logo`, `favicon`, `map`, `about`, `cservices`, `phone`, `colorpry`, `colorsec`, `font`) VALUES
(1, 'Segunda version', 'Segunda version', 'Segunda version', 'Segunda version', 'Segunda version', '', 'Segunda version', 'Segunda version', 'Segunda version', 'img/imgconfig/favicon.png', 'SisteDvn', 'Lorem Ipsum is simply dummy text of the printing a', 'Lorem Ipsum is simply dummy text of the printing a', 'Lorem Ipsum is simpl', '#f202f2', '#ffa3a3', '#ffb8b8');
...
INSERT INTO `pagina` (`pagid`, `pagnom`, `pagarc`, `pagmos`, `pagord`, `pagmen`, `icono`) VALUES
(301, 'Dominio', 'vista/vdom.php', 1, 1, 'Home', 'fas fa-thermometer-full'),
(302, 'Perfil', 'vista/vpef.php', 1, 34, 'Home', 'fas fa-users ico'),
(303, 'Categorias', 'vista/vcate.php', 1, 12, 'Home', 'fas fa-solid fa-tag'),
(304, 'Productos', 'vista/vprod.php', 1, 2, 'Home', 'fas fa-solid fa-dumpster-fire'),
(305, 'Producto Imagen', 'vista/vprodimg.php', 2, 3, 'Home', 'fas fa-thermometer-full ico'),
(307, 'Valor', 'vista/vval.php', 1, 36, 'Home', 'fas fa-thermometer-empty ico'),
(308, 'Pagina', 'vista/vpag.php', 1, 33, 'Home', 'fas fa-copy'),
(309, 'Marcas Amarillo', 'vista/vtrademark.php', 1, 10, 'Home', 'fas fa-map-marker-alt ico'),
(1008, 'Usuario - Local', 'vista/vuser.php', 1, 5, 'Home', 'fas fa-users ico'),
(1009, 'Configuracion', 'vista/vconfig.php', 1, 12, 'Home', 'fas fa-thermometer-empty ico'),
(1069, NULL, '#Espacio', 1, 98, 'Home', 'fas fa-car-alt ico'),
(1070, 'Salir', 'vista/vsal.php', 1, 99, 'Home', 'fas fa-sign-out-alt ico');
...
INSERT INTO `product` (`idprod`, `pname`, `price`, `trademark`, `model`, `category`, `discount`, `cdescription`, `cstatus`) VALUES
(2, 'Celuar XIAOMI REDMI NOTE 1', '390000', 2, '', 1, 0, 'fddffddf', 1),
(3, 'Celuar XIAOMI REDMI NOTE 2', '3225', 1, '', 1, 0, 'fddffddf', 1),
(4, 'SAMSUNG A03 ', '396000', 1, '', 1, 0, 'fddffddf', 1),
(5, 'CELULAR SAMSUNG A32', '39800', 1, 'A03 S', 1, 0, 'DS232232', 2),
(6, 'Celular Motorola A03', '370000', 1, 'MOTO G 5', 1, 0, 'ZZZ111122221112223232323123', 1),
(9, 'Celular', '378000', 1, '323', 1, 0, 'this is a new phone', 1),
(10, 'Celuar XIAOMI REDMI NOTE 2', '1000000', 1, '4G', 3, 0, 'Procesador OCTACORE', 1),
(11, 'CELULAR SAMSUNG A32', '3225', 1, '1.50 x 2.0', 1, 0, '2332', 1),
(12, 'Celuar XIAOMI REDMI NOTE 1', '3225', 1, '1.50 x 2.0', 1, 0, 'XIAOMIII', 1),
(13, 'CELULAR SAMSUNG A32', '460000', 2, '1.50 x 2.0', 3, 0, 'YTYTYTYT', 1),
(14, 'Celuar XIAOMI REDMI NOTE 1', '3225', 1, '1.50 x 2.0', 2, 0, '2332', 1),
(15, 'SAMSUNG A03 ', '396000', 1, '', 1, 0, 'fddffddf', 1),
(16, 'Tarjeta De Desarrollo Uno R3 Montaje Superficial', '39900', 1, 'ATmega328P', 1, 0, 'ATmega328 AU-UNO microcontrolador con el cargador ', 1),
(17, 'Duvan', '10000', 1, '1996', 1, 0, 'Una unidad de Duvan a precio comodo', 1);
...
CREATE TABLE `trademark` (
  `idtrademark` bigint(11) NOT NULL,
...
INSERT INTO `trademark` (`idtrademark`, `tname`, `timg`) VALUES
(1, 'Susuki', 'ing/temp'),
(2, 'Homda', 'img/');
...
CREATE TABLE `usuario` (
  ...
  `codubi` bigint(11) DEFAULT NULL,
  `emausu` varchar(100) DEFAULT NULL,
  `pasusu` varchar(100) DEFAULT NULL,
  `actusu` tinyint(1) DEFAULT NULL,
  `fecsolusu` datetime DEFAULT NULL,
  `clausu` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`idusu`, `nomusu`, `apeusu`, `docid`, `pefid`, `telusu`, `codubi`, `emausu`, `pasusu`, `actusu`, `fecsolusu`, `clausu`) VALUES
(1, 'DUVAN FERNANDO ', 'ROBAYO ALAPE', '1072711329', 1, '3118256112', 25175, 'xx.duvanxx@hotmail.com', '8cb2237d0679ca88db6464eac60da96345513964\n', 1, NULL, NULL);
...
--
-- Indices de la tabla `html_configuration`
--
ALTER TABLE `html_configuration`
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fkpefid` (`pefid`),
  ADD KEY `fkcodubi` (`codubi`);
...
--
ALTER TABLE `category`
  MODIFY `idcate` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `dominio`
--
ALTER TABLE `dominio`
  MODIFY `iddom` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `files`
--
ALTER TABLE `files`
  MODIFY `idimg` bigint(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pagina`
--
ALTER TABLE `pagina`
  MODIFY `pagid` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1071;

--
-- AUTO_INCREMENT de la tabla `perfil`
--
ALTER TABLE `perfil`
  MODIFY `pefid` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `product`
--
ALTER TABLE `product`
  MODIFY `idprod` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `trademark`
--
ALTER TABLE `trademark`
  MODIFY `idtrademark` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `ubicacion`
--
ALTER TABLE `ubicacion`
  MODIFY `codubi` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99774;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `idusu` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;

--
-- AUTO_INCREMENT de la tabla `valor`
--
ALTER TABLE `valor`
  MODIFY `codval` bigint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `files`
  ADD CONSTRAINT `files_ibfk_1` FOREIGN KEY (`idprod`) REFERENCES `product` (`idprod`);
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`category`) REFERENCES `category` (`idcate`),
  ADD CONSTRAINT `product_ibfk_2` FOREIGN KEY (`trademark`) REFERENCES `valor` (`codval`);
...
ALTER TABLE `usuario`
  ...
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`codubi`) REFERENCES `ubicacion` (`codubi`);
