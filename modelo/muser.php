...
//Método de mostrar usuarios
	public function selusu(){
		...
		$modelo = new conexion();
		$conexion = $modelo->get_conexion();
		$sql = "SELECT u.idusu, u.nomusu, u.apeusu, u.docid, u.pefid, u.telusu, u.codubi, u.address, u.emausu, u.facebook, u.instagram, u.icon, u.map, u.about, u.services, u.emausu, u.pasusu, u.actusu, u.fecsolusu, u.clausu, p.pefnom AS pfl FROM usuario AS u INNER JOIN perfil AS p ON u.pefid=p.pefid";
